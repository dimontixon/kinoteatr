...
$allfilmgenre = $MyData->query("SELECT * from `film_genre` where `film_genre`.`film_id` = ".$film_id);
$rowfilmgenre = $allfilmgenre->fetch_assoc();

$allfilmcountry = $MyData->query("SELECT * from `film_country` where `film_id` = ".$film_id);
                    ...
                    <form method="post" class="contact-form">
                            ...
                            <div class="col-md-4">
                                ...
                                <select multiple required title="Виберіть країну" class="form-control selectpicker" size="0" name="country[]" id="country">
                                    ...
                                    while(($row_country = $allcountry->fetch_assoc())!=false){
                                        if($rowfilmcountry['country_id'] == $row_country['id']){
                            ...
                            <div class="col-md-4">
                                ...
                                <select multiple required title="Виберіть жанр" class="form-control selectpicker" size="0" name="genre[]" id="genre">
                                    ...
                                    while(($row_genre = $allgenre->fetch_assoc())!=false){
                                        if($rowfilmgenre['genre_id'] == $row_genre['id']){
                        ...
                        <div class="row form-group">
                            <div class="col-md-10">
                                ...
                                <input required name="photo" value="<?=$photo?>" type="file" id="form_photo" class="form-control-file">
                            </div>
                        </div>
